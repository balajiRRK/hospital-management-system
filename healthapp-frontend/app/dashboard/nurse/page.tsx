...
export default function NurseDashboard() {
  ...
  useEffect(() => {
    ...
    async function fetchPatients() {
      ...
      setAppointments(nurseAppointments);
      const uniquePatients = Array.from(new Set(nurseAppointments.map((a) => a.patientId))).map(
        (id) => ({ id }),
      );
            ...
            <div className="flex-1 space-y-4">
              {activeTab === 'Patient Data' && selectedPatientProfile ? (
                ...
                <div className="space-y-2 rounded-lg bg-white p-4 shadow dark:bg-gray-800">
                  ...
                  <p>
                    <strong>Name:</strong> {selectedPatientProfile.firstName || 'N/A'}{' '}
                    {selectedPatientProfile.lastName || 'N/A'}
                  </p>
                  <p>
                    <strong>Email:</strong> {selectedPatientProfile.email || 'N/A'}
                  </p>
                  <p>
