  ...
  return (
    <div className="flex min-h-screen overflow-y-auto bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex flex-1 flex-col">
        ...
        {(activeTab === "Results" || activeTab === "Patients") && (
          <main className="flex gap-6 p-8">
              ...
              {activeTab === "Results" ? (
                selectedPatientProfile ? (
                  <div className="space-y-2">
                    <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Enter Visit Result</h2>
                    <textarea
                  ...
                  <p className="text-gray-500">Select a patient to enter results</p>
                )
              ) : selectedPatientProfile ? (
                <div className="space-y-2">
                  ...
                  <p><strong>Address:</strong> {selectedPatientProfile.address
                  ...
                  <p><strong>Emergency Contact:</strong> {selectedPatientProfile.emergencyContact
